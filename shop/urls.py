...
urlpatterns = [
    ...
    #What <int:pk> means: this is a URL parameter — it captures whatever number appears in that position in the URL (e.g. /customers/3/edit/ captures 3)
    ...
    path('api/tank-level/', TankLevelAPIView.as_view(), name='tank_level_api'), 
    # TankLevelAPIView is a class-based view, not a function-based view, so it can't be referenced as views.TankLevelAPIView the same way your other views are — you need to import it explicitly by name.
